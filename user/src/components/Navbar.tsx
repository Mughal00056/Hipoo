        ...
        <div className="flex items-center justify-between h-16 sm:h-20 gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={onMenuClick}
              className="p-2 text-zinc-650 hover:text-indigo-600 dark:text-zinc-400 dark:hover:text-indigo-400 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-xl transition-all cursor-pointer mr-1 relative flex items-center justify-center border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a]"
            ...
            >
              ...
              <div>
                <span className="font-sans font-black text-lg sm:text-xl tracking-tighter bg-gradient-to-r from-zinc-900 to-indigo-950 dark:from-white dark:to-indigo-250 bg-clip-text text-transparent uppercase">
                  Aether<span className="text-indigo-505 font-light">Vault</span>
                </span>
          ...
          <div className="flex items-center gap-2 sm:gap-3.5">
            ...
            <button
              ...
              className="p-2.5 text-zinc-505 hover:text-red-500 dark:text-slate-450 dark:hover:text-red-400 rounded-lg bg-zinc-100/55 dark:bg-white/5 hover:bg-zinc-100 dark:hover:bg-white/10 border border-transparent dark:border-white/10 transition-colors relative cursor-pointer"
            ...
            <button
              ...
              className="p-2.5 text-zinc-505 hover:text-indigo-600 dark:text-slate-450 dark:hover:text-indigo-400 rounded-lg bg-zinc-100/55 dark:bg-white/5 hover:bg-zinc-100 dark:hover:bg-white/10 border border-transparent dark:border-white/10 transition-colors relative cursor-pointer"
              title="View Cart"
            >
                  ...
                  <motion.button
                    ...
                    className={`flex items-center gap-2 px-3.5 sm:px-4.5 py-1.5 sm:py-2 rounded-full text-xs font-sans font-semibold transition-all duration-300 whitespace-nowrap cursor-pointer select-none ${
                      isActive
                        ...
                        : 'bg-zinc-100 dark:bg-white/5 text-zinc-650 dark:text-slate-400 hover:bg-zinc-200/70 dark:hover:bg-white/10 hover:text-zinc-900 dark:hover:text-white border border-transparent dark:border-white/5'
                    }`}
                  >
