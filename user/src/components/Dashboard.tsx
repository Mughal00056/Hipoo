      ...
      >
        ...
        <div className="px-6 py-6 border-b border-zinc-150 dark:border-zinc-900 bg-zinc-50/50 dark:bg-zinc-900/15 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-505 font-mono -mt-0.5">{user.email}</p>
            <div className="mt-1.5 flex flex-wrap gap-2 justify-center sm:justify-start">
              ...
              <span className="px-2 py-0.5 text-[9px] font-mono bg-red-50 text-red-650 dark:bg-red-955/20 dark:text-red-400 rounded-md border border-red-100/20">
          ...
          <button
            ...
            className={`pb-3 pt-4 text-xs sm:text-sm font-sans font-semibold border-b-2 px-6 transition-colors whitespace-nowrap cursor-pointer ${
              activeTab === 'downloads'
                ...
                : 'border-transparent text-zinc-400 hover:text-zinc-755 dark:hover:text-zinc-200'
            }`}
          >
            My Downloads
          </button>
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="space-y-4">
              {user.purchasedProducts.length === 0 ? (
                <div className="py-16 text-center space-y-3 p-6 border border-dashed border-zinc-150 dark:border-zinc-850 rounded-2xl">
                  <Inbox className="w-10 h-10 text-zinc-300 dark:text-zinc-755 mx-auto" />
          ...
          {activeTab === 'wishlist' && (
            <div className="space-y-4">
              {wishlistProducts.length === 0 ? (
                <div className="py-16 text-center space-y-3 p-6 border border-dashed border-zinc-150 dark:border-zinc-850 rounded-2xl">
                  <Heart className="w-10 h-10 text-zinc-300 dark:text-zinc-755 mx-auto" />
                  ...
                  {wishlistProducts.map((p: Product) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col justify-between">
                        ...
                        <div className="flex items-center gap-2 mt-2 pt-1 border-t border-zinc-150/55 dark:border-zinc-855/50">
                          <button
                            id={`wish-add-${p.id}`}
          ...
          {activeTab === 'profile' && (
            <form onSubmit={handleSaveProfile} className="space-y-4 max-w-md mx-auto">
              ...
              <div>
                <label className="block text-[11px] font-mono text-zinc-404 dark:text-zinc-400 uppercase tracking-wide mb-1">Email Address</label>
                <input
